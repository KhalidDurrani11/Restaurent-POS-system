          ...
          <div className="rounded-md -space-y-px">
            <div>
              <input
                ...
                required
                className="appearance-none rounded-none relative block w-full px-4 py-3 bg-white/5 border border-white/20 placeholder-gray-400 text-white rounded-t-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
            ...
            <div>
              <input
                ...
                required
                className="appearance-none rounded-none relative block w-full px-4 py-3 bg-white/5 border border-white/20 placeholder-gray-400 text-white rounded-b-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
